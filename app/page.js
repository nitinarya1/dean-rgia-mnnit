        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="space-y-6 animate-slide-in-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-50 text-teal-700 text-[11px] sm:text-xs font-bold tracking-wide uppercase border border-teal-100 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-teal-500 animate-pulse"></span>
                Welcome to RGIA
              </div>
              
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight tracking-tight">
                Resource Generation <br className="hidden sm:block" />
                <span className="text-teal-700">& International Affairs</span>
              </h2>
              
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl">
                The Office of the Dean (RGIA) at <span className="font-semibold text-slate-800">Motilal Nehru National Institute of Technology Allahabad</span> works towards fostering global partnerships, promoting international academic exchange, and mobilizing financial resources from alumni to support technological development.
              </p>
              
              <div className="flex flex-wrap gap-4 pt-4">
                <Link href="/resource-generation" className="px-6 py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-semibold transition-all shadow-md shadow-teal-500/20 hover:shadow-teal-500/40 hover:-translate-y-0.5">
                  Explore Initiatives
                </Link>
                <Link href="/mou" className="px-6 py-3 rounded-xl bg-white border border-slate-200 hover:border-teal-400 hover:bg-teal-50 text-slate-700 font-semibold transition-all hover:-translate-y-0.5 shadow-sm">
                  View MoUs
                </Link>
              </div>
            </div>

            {/* Right Content - Visual Stats Elements */}
            <div className="relative animate-fade-in-up stagger-2 hidden sm:block">
              <div className="absolute inset-0 bg-gradient-to-tr from-teal-100 to-amber-50 rounded-3xl transform rotate-3 scale-105 -z-10 shadow-inner"></div>
              <div className="glass-card p-6 md:p-8 rounded-3xl relative overflow-hidden bg-white/90">
                <div className="grid grid-cols-2 gap-8">
                   <div className="space-y-2 p-4 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                     <h3 className="text-3xl font-black text-slate-900 border-b-[3px] border-amber-500 inline-block pb-1">Global</h3>
                     <p className="text-sm text-slate-500 font-semibold tracking-wide">MoUs & Tie-ups</p>
                   </div>
                   <div className="space-y-2 p-4 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                     <h3 className="text-3xl font-black text-slate-900 border-b-[3px] border-teal-500 inline-block pb-1">Impact</h3>
                     <p className="text-sm text-slate-500 font-semibold tracking-wide">Resource Funding</p>
                   </div>
                   <div className="space-y-2 p-4 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                     <h3 className="text-3xl font-black text-slate-900 border-b-[3px] border-blue-500 inline-block pb-1">Alumni</h3>
                     <p className="text-sm text-slate-500 font-semibold tracking-wide">Global Network</p>
                   </div>
                   <div className="space-y-2 p-4 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                     <h3 className="text-3xl font-black text-slate-900 border-b-[3px] border-purple-500 inline-block pb-1">Research</h3>
                     <p className="text-sm text-slate-500 font-semibold tracking-wide">Publications</p>
                   </div>
                </div>
              </div>
            </div>
