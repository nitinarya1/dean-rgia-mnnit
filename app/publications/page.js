            ...
            <div className="space-y-8">
              {publications.map((pub, index) => (
                ...
                >
                  ...
                  <div className="w-full md:w-44 h-56 md:h-60 rounded-2xl bg-slate-100 flex items-center justify-center shrink-0 border border-slate-200 overflow-hidden shadow-sm group-hover:shadow-md transition-shadow">
                    <div className="text-center p-4">
                      ...
                      <p className="text-slate-500 text-xs font-medium">Book Cover</p>
                    </div>
                  </div>
