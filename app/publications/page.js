    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-slate-900">Publications</h1>
          <span className="text-slate-400 text-sm hidden sm:inline">— Books authored by our distinguished alumni and faculty</span>
        </div>
      </div>
