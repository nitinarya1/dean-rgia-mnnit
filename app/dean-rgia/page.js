                          ...
                          {pastDeans.map((dean, index) => (
                            ...
                            >
                              ...
                              <div className="p-8 flex flex-col items-center text-center flex-1 bg-white">
                                ...
                                <div className="mt-auto pt-5 border-t border-slate-100 w-full flex flex-col items-center">
                                  <p className="text-slate-600 text-sm font-semibold flex items-center justify-center gap-2 mb-3">
